    ...
    return (
        <ContainerSection className="WorkDescriptionContent">
            <div className="workDescriptionContent__content">
                <div className="workDescriptionContent__title" data-aos="fade-left" data-aos-duration="2000">
                    <TypeH2 >Front End Developer / Diseñador UI</TypeH2>
                </div>
                <div className="workDescriptionContent__txt" data-aos="fade-right" data-aos-duration="2000">
                    <TypeBody1 >

    ...
    return (
        <ContainerSection className="BioAboutMeContent">
            <div className="bioAboutMeContent__content">
                <div className="bioAboutMeContent__title" data-aos="fade-left" data-aos-duration="2000">
                    <TypeH2>Un poco sobre mi</TypeH2>
                </div>
                <div className="bioAboutMeContent__subtitle" data-aos="fade-right" data-aos-duration="2000">
                    <TypeBody1>
